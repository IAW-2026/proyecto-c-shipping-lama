  ...
  return (
    <main className="min-h-screen bg-[#8FA18D] text-black flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center text-center px-6 py-10 relative overflow-hidden bg-[#f6f1e7]">
        ...
        >
          Ingresar al panel
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="transition-transform duration-200 group-hover:translate-x-0.5">
            <path d="M5 12h14" />
        ...
        <div className="flex gap-2">
          <div className="flex justify-center mt-3 -mb-8">
            <Image src="/box2.png" width={55} height={70} className="hidden md:block opacity-25" alt="" />
          </div>
          <div className="flex justify-center mt-3 -mb-8">
            <Image src="/box2.png" width={55} height={70} className="hidden md:block opacity-50" alt="" />
          </div>
          <div className="flex justify-center mt-3 -mb-8">
            <Image src="/box2.png" width={55} height={70} className="hidden md:block opacity-75" alt="" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col gap-2 bg-[#6f7f6d]/60 p-3 rounded-xl">
            <div className="flex gap-1.5">
              ...
              <h3 className="text-2sm font-medium text-[white]/80 py-1">Seguimiento en tiempo real</h3>
            </div>
            <p className="text-xs text-white/40 leading-relaxed">Actualiza el estado de cada envío y el comprador lo ve al instante.</p>
          </div>
          ...
          <div className="flex flex-col gap-2 bg-[#6f7f6d]/60 p-3 rounded-xl">
            <div className="flex gap-1.5">
              ...
              <h3 className="text-2sm font-medium text-[white]/80 py-1">Historial completo</h3>
            </div>
            <p className="text-xs text-white/40 leading-relaxed">Cada evento del envío queda registrado con fecha, estado y operador asignado.</p>
          </div>
          ...
          <div className="flex flex-col gap-2 bg-[#6f7f6d]/60 p-3 rounded-xl">
            <div className="flex gap-1.5">
              ...
              <h3 className="text-2sm font-medium text-[white]/80 py-1">Multi-operador</h3>
            </div>
            <p className="text-xs text-white/40 leading-relaxed">Cada operador logístico accede a sus envíos asignados de forma independiente.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-white/5 px-8 py-2 flex items-center justify-between">
        <span className="text-xs text-white/30">lama © {new Date().getFullYear()}</span>
